...
Chequear funcionamiento interfaces descartando problemas por recepción de estados.

En este caso, la obtención de estados está DESHABILITADA más allá de la versión de SDK.
...
from moduloTello import *

miDron = TelloSinEstados()
